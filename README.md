...
Бэкэнд написан на Laravel 8, но не демонстрируется в данном проекте. Когда-то бэкэнд был развернут в интернете, но сейчас его нет. Поэтому Вы можете смотреть только код данного проекта.
